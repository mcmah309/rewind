...
class Printer {
  ...
  List<String> formatAndPrint(
    ...
    for (var entry in entries) {
      buffer.add('${color('$verticalLineAtLevel$emoji${entry.header}')}${entry.headerMessage ?? ''}');
...
class Entry {
  ...
  Entry(this.header, {this.headerMessage, this.message});
}
